...
class MainActivity : AppCompatActivity() {
  ...
  private lateinit var _collections: Collections
  ...
  val collections get() = this._collections
      ...
      Preferences.smState
        ...
        .subscribe { it ->
          syncStatus.text = when (it) {
            ...
            SyncState.UPLOAD_COLLECTIONS -> "Sinc. Colectări"
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    _collections = Collections(Database.collection, Database.vehicle, Preferences, location)
  }
  ...
  private val featMgr: FeatureManager
